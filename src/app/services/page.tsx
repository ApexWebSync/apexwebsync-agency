    ...
    <div className="pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 text-center">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold text-white tracking-tight">
          Bespoke Code &amp; <span className="text-[#00d2ff]">Search Supremacy</span>
        </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-16">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-cyan-950/40 via-blue-950/40 to-slate-900 border border-cyan-500/30 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
          ...
          <Link
            href="/contact"
            className="px-8 py-3.5 rounded-2xl bg-gradient-to-r from-[#00d2ff] to-[#2563eb] text-slate-950 font-bold text-xs uppercase tracking-wider shrink-0 hover:opacity-90 shadow-xl shadow-cyan-500/25 flex items-center gap-2"
          >
